...
The last column names the test cases that cover the task. The cases run from `T-01` to `T-56` and come from the case table in [`docs/test-plan.md`](test-plan.md#cases).
